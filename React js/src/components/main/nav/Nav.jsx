...
export default function Nav() {
    ...
    useEffect(() => {
        const isScrolled = localStorage.getItem('scrolled');
        if (isScrolled === 'true') {
            setScrolled(true);
        }
    ...
    return (
<>          
    <nav className={scrolled ? `${classes.navbar} ${classes.scrolled}` : `${classes.navbar}`}>
            <div className={`${classes.menubar}`}>
        <button className={`${classes.logo_button}`}>
            <img src={logo} alt="" className={`${classes.logo}`}/>
        </button>

        <button className={`${classes.mobile_menu_button}`}>
            <img src={mobile_menu} alt="" />
            <span className={`${classes.mobile_menu_button_text}`}>МЕНЮ</span>
        </button>

        <div className={`${classes.food_list}`}>
        <div className={`${classes.promotion}`}>
            <button>
                <span className={`${classes.nav_text}`}>АКЦИИ</span>
                <img src={fire} alt="" className={scrolled ? `${classes.promotion_fire_scrolled}` : `${classes.promotion_fire}`}/>
            </button>
        </div>
        <div className={`${classes.hot}`}>
            <button className={`${classes.hot_text_button}`}>
                <span className={`${classes.nav_text}`}>ГОРЯЧЕЕ&nbsp;</span>
                <img src={chicken} alt="" className={scrolled ? `${classes.hot_chicken_scrolled}` : `${classes.hot_chicken}`}></img>
            </button>
        </div>
        <div className={`${classes.cold}`}>
            <button className={`${classes.cold_text_button}`}>
                <span className={`${classes.nav_text}`}>ХОЛОДНОЕ&nbsp;</span>
                <img src={ice_cream} alt="" className={scrolled ? `${classes.cold_ice_scrolled}` : `${classes.cold_ice}`}/>
            </button>
        </div>
        <div className={`${classes.fresh_bakery}`}>
            <button className={`${classes.fresh_bakery_text_button}`}>
                <span className={`${classes.nav_text}`}>СВЕЖАЯ ВЫПЕЧКА</span>
            </button>
        </div>
        <div className={`${classes.desserts}`}>
        <button className={`${classes.desserts_text_button}`}>
                <span className={`${classes.nav_text}`}>ДЕСЕРТЫ</span>
            </button>
        </div>
        <div className={`${classes.drinks}`}>
        <button className={`${classes.drinks_text_button}`}>
                <span className={`${classes.nav_text}`}>НАПИТКИ</span>
            </button>
        </div>
        </div>
